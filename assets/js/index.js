...
cursos.push(new Curso("2", "React", 149.50, "Curso ensina pensamento em React JS, design eficiente, Firebase, prototipagem. Desenvolvimento de aplicações SPA focado no usuário final.", "assets/images/react.png"));
...
cursos.push(new Curso("8", "PYTHON", 249.50, "Curso explora os principais princípios e funções da linguagem Python em aplicações de dados.", "assets/images/python.png"));
...
cursos.push(new Curso("10", "SQL", 199.50, "Curso abrange noções centrais de banco de dados relacionais, implementação de consultas SQL e analise de banco de dados.", "assets/images/sql.png"));
